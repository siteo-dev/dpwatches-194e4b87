...
const CHECKOUT_URL = 'https://vnckxwbzbmtdqsvgrnfg.supabase.co/functions/v1/create-checkout?submission_id=194e4b87-d763-4673-9ef5-4bfb30745ae6'
          ...
          >
            ...
            <CardContent className="relative z-10 p-5 sm:p-10">
                ...
                <Card className="rounded-2xl relative overflow-hidden" style={{ borderColor: `rgba(${ACCENT_RGB}, 0.3)`, backgroundColor: `rgba(${ACCENT_RGB}, 0.05)` }}>
                  ...
                  <CardContent className="p-4 sm:p-6 flex flex-col h-full">
                    ...
                    <div className="relative mt-auto">
                      <Button asChild className="relative w-full rounded-full font-semibold overflow-hidden" style={{ backgroundColor: ACCENT, color: '#fff' }}>
                        <a href={`${CHECKOUT_URL}&plan=growth`} rel="noopener noreferrer">
                          Choose Growth
                          <ArrowRight className="w-5 h-5 ml-2" />
                          <BorderBeam size={100} duration={6} colorFrom={ACCENT} colorTo="white" />
                        </a>
                      </Button>
                    </div>
                  </CardContent>
              ...
              <div className="relative rounded-2xl mb-5 sm:mb-8 overflow-hidden">
                ...
                <div className="bg-zinc-950/80 backdrop-blur-sm rounded-2xl p-6 sm:p-8">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-3">
                        <Sparkles className="w-5 h-5 flex-shrink-0" style={{ color: ACCENT }} />
                        <h3 className="text-base sm:text-lg font-semibold text-white">Need a fully custom website or advanced features?</h3>
                      </div>
                      <p className="text-sm text-zinc-400 leading-relaxed">If your business requires more than a standard setup — such as unique design, complex integrations, or tailored functionality — we've got you covered.</p>
                      <p className="text-sm text-zinc-300 mt-1.5 leading-relaxed">Schedule a quick discovery call and we'll prepare a solution built specifically for your goals.</p>
                    </div>
                    <div className="relative flex-shrink-0">
                      <Button asChild variant="outline" className="relative rounded-full border-white/10 text-white hover:bg-white/5 gap-2 whitespace-nowrap overflow-hidden">
                        <a href="tel:+40757289370">
                          <Phone className="w-4 h-4" />
                          +40 757 289 370
                          <BorderBeam size={80} duration={6} delay={2} colorFrom={ACCENT} colorTo="white" />
                        </a>
                      </Button>
                    </div>
                  </div>
