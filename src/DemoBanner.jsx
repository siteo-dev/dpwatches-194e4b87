...
const SUBMISSION_ID = '194e4b87-d763-4673-9ef5-4bfb30745ae6'
              ...
              <div className="grid sm:grid-cols-2 gap-4 sm:gap-5 mb-5 sm:mb-8">
                ...
                <Card className="rounded-2xl relative overflow-hidden" style={{ borderColor: `rgba(${ACCENT_RGB}, 0.3)`, backgroundColor: `rgba(${ACCENT_RGB}, 0.05)` }}>
                  ...
                  <CardContent className="p-4 sm:p-6 flex flex-col h-full">
                    ...
                    <ShimmerButton disabled={loadingPlan === 'growth'} onClick={() => handleCheckout('growth')} className="w-full h-11 font-semibold text-base mt-auto" background={ACCENT} shimmerColor="rgba(255,255,255,0.3)">
